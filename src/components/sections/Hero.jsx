...
function Hero() {
  return (
    <section className="container relative flex flex-col justify-center gap-y-16 md:gap-y-24 items-center pt-16 md:pt-28 text-4xl md:text-6xl text-center font-bold">
